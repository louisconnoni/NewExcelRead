...
def run_desalination_model(op, idx):
 ...
 while(counter<len(variables)):
     ...
     newuncertaintyvector[counter], neweconuncertainty[counter], newcarbonuncertainty[counter], newwateruncertainty[counter], newtotal, newsubs = ns.calculate(baseline_profit, baseline_carbon, baseline_water, baseline_social, totalprofit, totalcarbonsaved, totalwatersaved, socialscore, 3, variables[counter])
